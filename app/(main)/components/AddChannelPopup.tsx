...
export default function AddChannelPopup({
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-black/50 z-50">
            <div
                ref={modalRef}
                className="bg-white rounded-lg p-6 w-120 shadow-lg"
            >
                <h2 className="text-2xl font-medium mb-4 text-[#323339] tracking-wide">Create Channel</h2>

                {/* Channel Type Section */}
                <div className="mb-6">
                    <label className="block text-lg font-base mb-2 text-[#222831] tracking-wide">Channel Type</label>
                ...
                {/* Channel Name Input */}
                <div className="mb-6">
                    <label className="block text-lg font-base mb-2 text-[#222831] tracking-wide">Channel Name</label>
