        ...
        displayName: (val) =>
          !val.trim()
            ...
            : !validateDisplayName(val)
              ? "Display name must be at least 2 characters and can contain letters, numbers, spaces, underscores, or hyphens"
              : null,
        password: (val) => {
          ...
          <section className="flex flex-col justify-center m-8 mt-2 mb-2">
            ...
            >
              ...
              {fieldErrors.terms && (
                <span
                  id="terms-error"
                  className="text-red-600 text-sm mb-4 block"
                  role="alert"
                >
                  {fieldErrors.terms}
                </span>
              ...
              <div className="flex flex-col gap-2">
                ...
                <div id="signup-button-description" className="sr-only">
                  {!isFormValid &&
                    "Please fill out all required fields correctly to create account"}
                </div>
              </div>
