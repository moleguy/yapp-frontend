            ...
            <main className="flex-1 flex justify-center items-center m-8 rounded-[20px]">
                ...
                >
                    ...
                    <section className="flex flex-col justify-center m-8 mt-2 mb-2">
                        <p className="text-xl font-medium font-MyFont mt-4 text-[#1e1e1e] w-full">Yapp — Connect.
                            Collaborate. Communicate.</p>
                        <p className="text-xl font-base text-[#B6B09F] mb-8 tracking-wide">Register into Yapp
                            account</p>

                        <form onSubmit={handleSubmit}
                              className="flex flex-col justify-center flex-1 text-[#1e1e1e] font-MyFont" noValidate>
                            {/* email field */}
                                ...
                                {password && passwordStrength && (
                                    <div className="mt-2 space-y-1">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span
                                                className="text-xs font-medium capitalize text-gray-600">{passwordStrength}</span>
                                        </div>
                                    </div>
                                )}
